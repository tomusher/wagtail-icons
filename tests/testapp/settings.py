...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_wagtail_icons.db"),
}
...
WAGTAIL_ICONS_PROVIDERS = {
    "fontawesome": {
        "class": "wagtail_icons.providers.fontawesome.FontAwesomeIconProvider",
        "api_token": os.environ.get("FONTAWESOME_API_TOKEN"),
    },
}
